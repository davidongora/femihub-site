...
const FAQS = () => {
  ...
  const faqs = [
    ...
    {
      question: "What is Bulamu Bridge AI ?",
      answer:
    ...
    {
      question: "What services does Bulamu Bridge AI offer ?",
      answer:
        "Bulamu Bridge AI offers oncline consultation services for expectant mothers. Through our app, we provide access to qualified healthcare profesionals who can assist with prenatal care, postpartum support and maternal health advice.",
    },
    {
